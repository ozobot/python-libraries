...
class SyncLineFollower:
    ...
    @as_sync
    async def move(self, distance_mm: float, speed_mps: float) -> None:
        """
        ...
        .. code-block:: python
            ...
            robot.move(-200, 50)
        """
        await self._linefollower.move(distance_mm, speed_mps)
    ...
    async def set_velocity(self, linear_mps: float, angular_degps: float, duration_s: float) -> None:
        ...
        .. code-block:: python
            ...
            # move straight forward for 2.5 seconds
    ...
    async def follow_line(self, direction: Direction) -> tuple[Direction, list[ColorCode]]:
        ...
        Returns the intersection where it stopped at and a list of detected color codes.
    ...
    async def face_line_direction(self, direction: Direction) -> None:
        ...
        If the robot was previously following a line (see :py:meth:`follow_line`), calling this function rotates the robot to face the given direction relative to the current direction. When the direction is
