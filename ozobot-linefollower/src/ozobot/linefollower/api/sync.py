...
class SyncLineFollower:
    ...
    async def say_color(self, color: ClassifiedColor) -> None:
        ...
        .. code-block:: python
            ...
            # say "red"
            robot.say_color(ClassifiedColor.RED)
        """
    ...
    async def face_line_direction(self, direction: Direction) -> None:
        ...
        .. code-block:: python
            ...
            robot.reorient_to_line(Direction.RIGHT)
        """
