...
class Color(abc.ABC):
    ...
    def is_color(self, other: Color | None, *, epsilon: float = _IS_COLOR_EPSILON) -> bool:
        ...
        Compares with other :py:class:`NamedColor` or :py:class:`RawColor`.
...
class RawColor(Color):
    ...
    .. seealso::
        A classified color with a name can be defined by :py:class:`NamedColor`.
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        elif isinstance(other, NamedColor):
            return other == self  # this calls NamedColor's __eq__
        else:
            return False
...
class NamedColor(Color):
    ...
    .. seealso::
        Predefined colors are available as properties of this class, for example :py:attr:`NamedColor.BLACK`.
    ...
    # we had to define the values below the class definition because:
    ...
    BLACK: typing.ClassVar[NamedColor]
    """Predefined color constant - black"""

    RED: typing.ClassVar[NamedColor]
    """Predefined color constant - red"""

    GREEN: typing.ClassVar[NamedColor]
    """Predefined color constant - green"""

    BLUE: typing.ClassVar[NamedColor]
    """Predefined color constant - blue"""

    WHITE: typing.ClassVar[NamedColor]
...
NamedColor.BLACK = NamedColor("Black", RawColor(0, 0, 0))
NamedColor.RED = NamedColor("Red", RawColor(1.0, 0, 0))
NamedColor.GREEN = NamedColor("Green", RawColor(0, 1.0, 0))
NamedColor.BLUE = NamedColor("Blue", RawColor(0, 0, 1.0))
NamedColor.WHITE = NamedColor("White", RawColor(1.0, 1.0, 1.0))
