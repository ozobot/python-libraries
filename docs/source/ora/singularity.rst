...
In robotics, singularities occur in certain configurations given by the robot's kinematics where the robot loses one of its degrees
of freedom. Singularities are only relevant for linear movements.
