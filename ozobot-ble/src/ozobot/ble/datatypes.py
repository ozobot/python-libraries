...
class DeviceDescription:
    ...
    @classmethod
    def parse_from_advertisement_data(
        cls, device: BLEDevice, adv_data: AdvertisementData
    ) -> DeviceDescription:
        ...
        if (
            manufacturer_data
            and manufacturer_data[0] == PACKET_ID
            and len(manufacturer_data) > 24
        ):
            ...
            version = (
                ...
                int.from_bytes(manufacturer_data[25:27], "little")
                if len(manufacturer_data[23:27]) == 4
                else 0,
            )
        else:
            device_id = None
